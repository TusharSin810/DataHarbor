...
CREATE TABLE "SubmissionCache" (
    "id" SERIAL NOT NULL,
    "task_id" INTEGER NOT NULL,
    "options1" INTEGER NOT NULL,
    "options2" INTEGER NOT NULL,
    "options3" INTEGER NOT NULL,
    "options4" INTEGER NOT NULL,
    "options5" INTEGER NOT NULL,
    "options6" INTEGER NOT NULL,
    "options7" INTEGER NOT NULL,
    "options8" INTEGER NOT NULL,
